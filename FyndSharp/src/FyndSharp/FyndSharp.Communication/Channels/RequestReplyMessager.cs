...
namespace FyndSharp.Communication.Channels
{
    ...
    public class RequestReplyMessager<T> : IMessager, IDisposable where T : IMessager
    {
        ...
        public DateTime LastReceivedTime
        {
            get
            {
                return Messager.LastReceivedTime;
            }
        }
        ...
        public RequestReplyMessager(T theMessager)
        {
            ...
            theMessager.MessageSent += Messager_MessageSent;
        ...
        private void Messager_MessageReceived(object sender, MessageEventArgs e)
        {
        ...
        /// <param name="sender">Source of event</param>
        /// <param name="e">Event arguments</param>
        private void Messager_MessageSent(object sender, MessageEventArgs e)
        {
