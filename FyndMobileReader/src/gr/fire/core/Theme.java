...
public class Theme
{
	...
	public int decorTop=0,decorBottom=scrollSize,decorLeft=0,decorRight=0; // size of the decorations (pixels)
	...
	public static int[] createGradient(int start, int end, int length)
	{
		...
		for (int i = 0; i < count; i++)
		{
			...
			result[i] = ((startAlpha << 16) & 0xFF000000) | ((startRed << 8) & 0x00FF0000) | (startGreen & 0x0000FF00) | (startBlue >>> 8);
		}
		return result;
	}
