...
import com.yinpsoft.beans.Customer;
 ...
 * 
 * @see com.yinpsoft.beans.Customer
...
public class CustomerDAO extends BaseDAO {
	...
	public Customer findById(java.lang.String id) {
		...
		try {
			Customer instance = (Customer) getSession().get(
					"com.yinpsoft.beans.Customer", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByIsvoid(Object isvoid) {
		return findByProperty(ISVOID, isvoid);
	}
